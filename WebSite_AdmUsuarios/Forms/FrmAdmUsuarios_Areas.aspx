<%@ Page Title="Adm. Usuarios - Áreas" Language="VB" MasterPageFile="~/MP_AdmUsuarios.master" AutoEventWireup="false" CodeFile="FrmAdmUsuarios_Areas.aspx.vb" Inherits="Forms_FrmAdmUsuarios_Areas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" runat="Server">
    <script src="../Scripts/Forms/FrmAdmUsuarios_Areas.js"></script>
    <div id="DivFormulario">
        <div id="DivEncabezado"><span id='spanEncabezado'>Áreas</span></div>
            ...
            <div id="DivLateralContenido">
                <div class="row separadorRow50">
                    <div class="col-lg-12 text-center">
                        <span id="spanLateralContenido">Áreas</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12 text-center">
        ...
        <div id="DivContenido">
            ...
            <div id="DivContenidoMedio">
                <div id="GrillaContenido" class="DivGrillaUsuarios DatoFormulario"></div>
            </div>
