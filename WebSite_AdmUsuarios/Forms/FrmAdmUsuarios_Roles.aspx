<%@ Page Title="Adm. Usuarios - Roles" Language="VB" MasterPageFile="~/MP_AdmUsuarios.master" AutoEventWireup="false" CodeFile="FrmAdmUsuarios_Roles.aspx.vb" Inherits="Forms_FrmAdmUsuarios_Roles" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" runat="Server">
    <script src="../Scripts/Forms/FrmAdmUsuarios_Roles.js"></script>
    <div id="DivFormulario">
        <div id="DivEncabezado"><span id='spanEncabezado'>Roles</span></div>
            ...
            <div id="DivLateralContenido">
                <div class="row separadorRow50">
                    <div class="col-lg-12 text-center">
                        <span id="spanLateralContenido">Roles</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12 text-center">
        ...
        <div id="DivContenido">
            ...
            <div id="DivContenidoMedio">
                <div id="GrillaContenido" class="DivGrillaUsuarios"></div>
            </div>
