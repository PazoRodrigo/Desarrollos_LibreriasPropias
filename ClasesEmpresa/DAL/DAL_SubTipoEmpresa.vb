...
Namespace DataAccessLibrary
    Public Class DAL_SubTipoEmpresa

#Region " Stored "
        Const storeAlta As String = "p_SubTipoEmpresa_Alta"
        Const storeBaja As String = "p_SubTipoEmpresa_Baja"
        Const storeModifica As String = "p_SubTipoEmpresa_Modifica"
        Const storeTraerUnoXId As String = "p_SubTipoEmpresa_TraerUnoXId"
        Const storeTraerTodos As String = "usp_consumos_SubTipoEmpresa_traerTodos"
        Const storeTraerTodosActivos As String = "p_SubTipoEmpresa_TraerTodosActivos"
#End Region
#Region " Métodos Públicos "
        ' ABM
        Public Shared Sub Alta(ByVal entidad As SubTipoEmpresa)
            ...
            End Using
        End Sub
        Public Shared Sub Baja(ByVal entidad As SubTipoEmpresa)
        ...
        End Sub
        Public Shared Sub Modifica(ByVal entidad As SubTipoEmpresa)
        ...
        Public Shared Function TraerUno(ByVal id As Integer) As SubTipoEmpresa
            ...
            Dim result As New SubTipoEmpresa
            Dim pa As New parametrosArray
            pa.add("@id", id)
            Using dt As DataTable = Connection.Connection.Traer(store, pa).Tables(0)
                If Not dt Is Nothing Then
        ...
        Public Shared Function TraerTodos() As List(Of SubTipoEmpresa)
            ...
            Dim pa As New parametrosArray
            Dim listaResult As New List(Of SubTipoEmpresa)
            Using dt As DataTable = Connection.Connection.Traer(store, pa).Tables(0)
...
#Region " Métodos Privados "
        Private Shared Function LlenarEntidad(ByVal dr As DataRow) As SubTipoEmpresa
            Dim entidad As New SubTipoEmpresa
            ' DBE
            ...
            If dr.Table.Columns.Contains("Id") Then
                ...
                End If
            End If
            If dr.Table.Columns.Contains("IdTipo") Then
                If dr.Item("IdTipo") IsNot DBNull.Value Then
                    entidad.IdTipoEmpresa = CInt(dr.Item("IdTipo"))
                End If
            End If
